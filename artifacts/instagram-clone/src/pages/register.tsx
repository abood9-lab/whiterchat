    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-background p-4 sm:p-6">
      ...
      >
        ...
        <div className="text-center space-y-2 flex flex-col items-center pt-2">
          <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-lg ring-1 ring-cyan-500/30 mb-2">
            <img src="/logo.png" alt="WhiterChat" className="w-full h-full object-cover" />
          </div>
