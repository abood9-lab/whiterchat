...
router.get("/api/ai/conversations/:id/messages", requireAuth, async (req: AuthRequest, res): Promise<void> => {
  try {
    const { id } = req.params;
    const conv = await AiConversation.findOne({ _id: new mongoose.Types.ObjectId(id), userId: new mongoose.Types.ObjectId(req.userId) } as any);
    if (!conv) {
...
router.delete("/api/ai/conversations/:id/messages", requireAuth, async (req: AuthRequest, res): Promise<void> => {
  try {
    const { id } = req.params;
...
// POST /api/ai/caption
router.post("/api/ai/caption", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
...
router.post("/api/ai/hashtags", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
...
// POST /api/ai/bio
router.post("/api/ai/bio", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
...
router.post("/api/ai/translate", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
...
// POST /api/ai/improve
router.post("/api/ai/improve", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
...
router.post("/api/ai/sentiment", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
...
// POST /api/ai/story
router.post("/api/ai/story", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
...
// POST /api/ai/roast
router.post("/api/ai/roast", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
...
router.post("/api/ai/reply-suggestions", requireAuth, aiLimiter, async (req: AuthRequest, res): Promise<void> => {
